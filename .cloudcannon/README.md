...
Open the files in [this site's data collection](cloudcannon:collections/data) in CloudCannon's _Data Editor_ to update the links in your header navigation and your website's SEO information. The colour, icon and tag options offered elsewhere in the editor are defined here too. Changes you make in the _Data Editor_ flow through to every page automatically.
